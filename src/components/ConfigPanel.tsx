  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>
          Current OAuth 2.0 + PKCE configuration for development
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        <div className="space-y-3">
          <div className="space-y-2">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm font-medium">Okta Issuer</span>
            </div>
            <code className="block text-xs bg-gray-100 p-2 rounded border">
              https://novataworkforcesandbox.oktapreview.com/oauth2/default
            </code>
          </div>
          ...
          <div className="space-y-2">
            ...
            {clientId === 'YOUR_CLIENT_ID' && (
              <p className="text-xs text-orange-600">
                ⚠️ Please update the client ID in oauthService.ts
              </p>
            )}
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              Configure this URI in your Okta application settings
            </p>
          </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-md p-3">
          ...
          <ol className="text-xs text-blue-700 space-y-1 list-decimal list-inside">
            <li>Update the Client ID in <code>src/services/oauthService.ts</code></li>
            <li>Add the redirect URI to your Okta app configuration</li>
