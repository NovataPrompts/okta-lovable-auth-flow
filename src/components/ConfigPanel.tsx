  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>
          Current OAuth 2.0 + PKCE configuration for sandbox development
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-md p-3">
          ...
          <ol className="text-xs text-blue-700 space-y-1 list-decimal list-inside">
            <li>Sandbox client ID is already configured</li>
            <li>Add the redirect URI to your Okta sandbox app configuration</li>
            <li>Ensure the Okta sandbox app is configured as a "Public" client type</li>
            <li>Enable PKCE in your Okta sandbox application settings</li>
          </ol>
        </div>
      </CardContent>
    </Card>
